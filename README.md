...
*   [From Good to Great: Cross-Functional Teams, by Zuzi Sochova](https://agile-scrum.com/2019/04/03/from-good-to-great-cross-functional-teams/)
...
*   [Continuous Integration vs Feature Branch Workflow, talk by Dave Farley](https://www.youtube.com/watch?v=v4Ijkq6Myfc)
*   [Feature Branching is Evil, talk by Thierry de Paux, at XP Days Ukraine 2017](https://www.youtube.com/watch?v=h4DM-Wa0aDQ)
...
* [What the Heck is the Event Loop Anyway; talk by Philip Roberts; at JSConf EU 2014](https://www.youtube.com/watch?v=8aGhZQkoFbQ)
...
* [The Next Paradigm Shift in Programming; talk by Richard Feldman](https://www.youtube.com/watch?v=6YbK8o9rZfI)
...
*   "Figure out for yourself what you want to be really good at, know that
    you'll never really satisfy yourself that you've made it, and accept that
    that's okay." – Robert B. Reich
*   "One cannot lead a life that is truly excellent without feeling that one
    belongs to something greater and permanent than oneself." – Mihaly
    Csikszentmihalyi
*   "Be prepared to cut your losses – canceling bad projects early is success
    because you save time, talent, money and resources that can be applied
    to better opportunities." – Ian Spence and Kurt Bittner
*   "Any intelligent fool can make things bigger and more complex... It takes
    ...
    direction." – "Small is Beautiful", by E.F. Shumacher
*   "Your work is shit." – Steve Jobs, interview with Bob Cringely
    *   Bob Cringely: "What does it mean when you tell someone their work
        is shit?"
    *   Steve Jobs:
        *   "It usually means their work is shit. Sometimes it means,
            'I think your work is shit. And I – I'm wrong'".
        *   "The most important thing I think yo can do for somebody who's
            really good and who's really being counted on is to point out
            to them when their work isn't good enough. And to do it very clearly
            and to articulate why ... and to get them back on track."
*   "When you have to fire people, do it with humility. Remember, the reason
    you have to fire them is not that they suck. It's not even that they suck
    at this job. It's that this job–the job you gave them–sucks for them." –
    Kim Scott
*   If no mistake have you made, yet losing you are… a different game you
    should play. -- Yoda
*   "The client or sponsor is the driver, yes, and has brought resources
    to bear to accomplish this goal that you’re managing, but you were not
    brought on to be a “yes” person.  (If you were, then stop reading right
    now and go find another job.  You’re in an unhealthy situation!)" –
    Jeniffer Hamel, in [How to say "no" to clients, bosses, and stakeholders](https://www.jennhamel.com/blog/2019/3/11/how-say-no-to-clients-bosses-and-stakeholders)
*   "If everything is under control, you're going too slow!" – Mario Andretti
*   "Anyone who has never made a mistake has never tried anything new." –
    Albert Einstein
*   "It does not matter how good you are, it does not matter how big you are,
    you can be taken down; if you are not agile." (talking about Nokia,
    Myspace, ...) – Jeff Sutherland
*   "You cannot make a commitment on anyone else's behalf and expect
    committed behavior from them." – Lisa Adkins
...
*   "Yes, we want to play football, we really like it...but let’s be pragmatic
    about it, the “by the book” football doesn’t really fit our context. So we
    will do 3 hours long matches because our players need more time to score.
    Also we don’t need trainer for our players, we will just tell them when to
    hit the ball and how (plus they saw a video about football and few of them
    are certified players now l). Also the ball is too hard for our players
    so we will use a beach ball and make the goals bigger. And goalkeeper will
    be a temporary role." – by Karel Slatinský
*   "Simple, clear purpose and principles give rise to complex and intelligent
    ...
    behavior." – by Dee Hock
*   "For the record, a single "I don't know" is enough to disqualify a story
    from sprint planning." – by Kelley O'Conell
*   "Scrum focuses on being agile which may (and should) lead to improving.
    Kanban focuses on improving, which may lead to being agile." – by Karl
    Scotland
*   "The first thing you’ll see is, much like you do with an
    application, **you’re not going to have 1 super-app that represents the
    whole company**; you’re going to break it down into many smaller services
    and applications that compose it." –
    [by Armon Dadgar](https://www.hashicorp.com/resources/terraform-workflow-best-practices-at-scale)
*   "We don't need an accurate document. We need a shared understanding." – by
    Jeff Patton
*   "Agility means that you are faster than your competition. Agile time frames
    are measured in weeks and months, not years." – by Michael Hugos
*   "We regularly coach groups that ask, 'How can we calculate how many people
    we will need?'. Our suggestion is, 'Start with a small group of great
    people, and only grow when it really starts to hurt.'. That rarely
    happens." – by Bas Vodde and Craig Larman
...
persistence support) database for storing various data types; it can also be
...
*   [Working Remotely (2015), by Todd Dewett](https://www.linkedin.com/learning/working-remotely-2015/welcome?u=2141129)
    *   ex: "Every productive behavior starts with a conscious choice. I want
    you to start the day by deciding that non-work activities will not be an option
    during your designated work time. Believe me, once you allow non-work
    activities to invade your work time, the easier it becomes to do it
    again, and again. Next, adopt this rule. No personal calls, emails,
    texts, instant messages, and so on. Yes, emergencies happen but they're
    rare and you need to protect your work time. Not only do I want you to
...
[Salt](https://docs.saltstack.com/en/latest/topics/) is:

*   A configuration management system. Salt is capable of maintaining remote
    nodes in defined states. For example, it can ensure that specific packages
    are installed and that specific services are running.
*   A distributed remote execution system used to execute commands and query
    data on remote nodes. Salt can query and execute commands either on
    individual nodes or by using an arbitrary selection criteria.

Seems like Salt is basically Ansible with state, that is not Ansible Tower :).
They both use Python and YAML.

*   [Using Salt for Configuration Management and Orchestration, video course on Linux Academy](https://linuxacademy.com/cp/modules/complete/id/190)
...
*   Official
    ...
    *   [Scrum Guide](http://www.scrumguides.org/scrum-guide.html)
    *   [Nexus Scrum](https://www.scrum.org/resources/online-nexus-guide) –
        for scaling scrum (when you need many people in a team)
*   Books
    *   [Agile Project Management for Dummies](https://www.safaribooksonline.com/library/view/agile-project-management/9781119405696/)
    *   [User Stories Applied](https://www.safaribooksonline.com/library/view/user-stories-applied/0321205685/)
*   LiveLessons
    *   [Agile Foundations LiveLessons](https://www.safaribooksonline.com/library/view/agile-foundations-livelessons/9780134578347/)
    *   [Agile Testing Essentials LiveLessons](https://www.safaribooksonline.com/library/view/agile-testing-essentials/9780134683287/)
    *   [Scrum Product Owner LiveLessons](https://www.safaribooksonline.com/library/view/scrum-product-owner/9780134840451/)
*   Other Safari Books Videos
    *   [Agile Discovery Series, Part 1](https://www.safaribooksonline.com/library/view/agile-discovery-series/9781634622745/9781634622745_1.html)
*   YouTube
    *   [How To Scale Scrum for Large Software Teams | The Nexus Framework from Scrum.org](https://www.youtube.com/watch?v=wuc3NPsL844&feature=share)
    *   [Ken Schwaber - Scaling Scrum to Sustain Productivity - 2015 COHAA The Path to Agility Conference](https://www.youtube.com/watch?v=xm4X7Hv_GOs&feature=share)
*   [Petr Motejlek's Safari Books Agile Playlist](https://www.safaribooksonline.com/playlists/a0d8720d-d068-4df2-aa1b-e3c0ab211cfa)
*   [Scrum Guide](http://www.scrumguides.org/scrum-guide.html)
    *   [Agile Foundations LiveLessons, by Mark Layton](https://www.safaribooksonline.com/library/view/agile-foundations-livelessons/9780134578347/)
    *   [Agile Testing Essentials LiveLessons](https://www.safaribooksonline.com/library/view/agile-testing-essentials/9780134683287/)
    *   [Agile Project Management for Dummies](https://www.safaribooksonline.com/library/view/agile-project-management/9781119405696/)
    *   [Scrum Product Owner LiveLessons](https://www.safaribooksonline.com/library/view/scrum-product-owner/9780134840451/)
    *   [Scrum Foundations, by Mike Cohn](https://www.mountaingoatsoftware.com/exclusive/scrum-foundations)
    *   Agile Discovery Series (videos)  
        *   [Introduction to Agile Software Development](https://www.safaribooksonline.com/videos/agile-discovery-series/9781634622745)
        *   [Agile Software Development with Scrum](https://www.safaribooksonline.com/videos/agile-discovery-series/9781634622752)
        *   [Agile and Scrum for Stakeholders](https://www.safaribooksonline.com/videos/agile-discovery-series/9781634622769)
    *   [Agile Sprints: What Happens & When During a Sprint](https://www.mountaingoatsoftware.com/blog/what-happens-when-during-a-sprint?utm_source=Iterable&utm_medium=email&utm_campaign=mgs_blog_2018July24&SNSubscribed=true)
    *   Product Owner
        *   [Six Guidelines for Saying No to a Stakeholder](https://www.mountaingoatsoftware.com/blog/six-guidelines-for-saying-no-to-a-stakeholder#.W1l9d_Qkrk8.linkedin)
*   [Do Scrum Teams Meet Too Much, by Mike Cohn](https://www.mountaingoatsoftware.com/blog/do-scrum-teams-meet-too-much)
*   [3 Agile Expers on the Role of the Scrum Master (VIMEO link)](https://vimeo.com/293105109?utm_medium=social&utm_source=linkedin&utm_campaign=statusbrew&utm_postid=bfb74d91d44d4de5b5bb2ba960d2599f)  
    *   [3 Agile Experts on the Role of the Scrum Master (direct link)](https://drive.google.com/file/d/1FbYv7SrmRCynyzpNNNe6rE-yo69HJTT6/view)
*   [Deadlines in Scrum, by Zuzi Šochová](https://agile-scrum.com/2018/10/18/deadlines-in-scrum/amp/)
*   [Personalized Guide to Agile, by Mike Cohn](https://www.mountaingoatsoftware.com/agile/personalized-guide?utm_source=LinkedIn&utm_medium=Blog%20Post%20November%2013&utm_campaign=LinkedIn%20Publisher)
*   [Scrum - Pitfalls from more than 10 years of practical experience, by Benjamin Lutz](https://www.linkedin.com/pulse/scrum-pitfalls-from-more-than-10-years-practical-experience-lutz/)
*   [Scrum Master Toolbox Podcast](https://scrum-master-toolbox.org/)
*   [Sprint Zero: A Good Idea or Not?, by Mike Cohn](https://www.mountaingoatsoftware.com/blog/sprint-zero-a-good-idea-or-not)
*   [GOTO 2015: Scrum at Scale, by Jeff Sutherland](https://www.youtube.com/watch?v=qEqrESsNWYs)
    *   A longer version of this: [Postgres Vision 2018, Keynote, Scrum at Scale, by Jeff Sutherland](https://www.youtube.com/watch?v=1JdqP4Zz1Wo)
*   [Scrum@Scale Guide](https://www.scrumatscale.com/scrum-at-scale-guide-read-online/)
*   [Coaching Agile Teams (Video), by Lisa Adkins](https://learning.oreilly.com/videos/coaching-agile-teams/9780133137897)
*   [Interlocking Agile Roles, video by Lisa Adkins](https://www.youtube.com/watch?v=4NMu10Ql90Y)
*   [Agile at Work: Driving Productive Agile Meetings, video by Doug Rose](https://www.linkedin.com/learning/agile-at-work-driving-productive-agile-meetings)
*   [7 lesson's I've learned using Scrum for infrastructure projects, article by Bob Molenaar](https://www.loginconsultants.com/en/news/tips-tricks/item/7-lessons-i-ve-learned-using-scrum-for-infrastructure-projects)
*   [Agile Scrum and Infrastructure, article by Craig Gmyrek](https://dzone.com/articles/agile-scrum-and-infrastructure)
*   [Do Scrum Teams Meet Too Much?, article by Mike Cohn](https://www.mountaingoatsoftware.com/blog/do-scrum-teams-meet-too-much)
*   [Why Scrum Isn't Making Your Company Very Agile: How Misconceptions About The Product Owner Role Harm Your Organization, and What To Do About It., presentation by Michael James](https://www.linkedin.com/feed/update/urn:li:ugcPost:6556959041560600576)
*   [Scrum & The Toyota Production System, Build Ultra-Powerful Teams, article by Pierre Jannez](https://www.infoq.com/articles/scrum-toyota-production-system/)
*   [How Scrum Patterns help you become a better Scrum Master, blog post by Karel Smutný](https://www.linkedin.com/pulse/how-scrum-patterns-help-you-become-better-master-karel-smutn%25C3%25BD-1e/?trackingId=tT21tl6bStiW%2FQI2tXbnsg%3D%3D)
*   [Differences Between Scrum and Extreme Programming, blog post by Mike Cohn](https://www.mountaingoatsoftware.com/blog/differences-between-scrum-and-extreme-programming#.XaiiW0G8DMA.linkedin)
*   [Jeremy Stafford's answer to Do programmers really like Scrum?](https://www.quora.com/Do-programmers-really-like-Scrum/answer/Jeremy-Stafford?ch=10&share=e88e4c6b&srid=i4sz)
*   [Common Dysfunctions of Scrum Teams, Part I, post by "The Clever PM"](http://www.cleverpm.com/2015/06/23/common-dysfunctions-of-scrum-teams-part-1/)
...
[/tz](https://slashtz.com) is an internet service (but can also be integrated
into Slack) that can be used for very quick time zone conversions. A notable
feature is the ability to ask for the best time to meet between multiple time
zones/cities.

# [snap](https://snapcraft.io)(s)
...
and installable from the [Snap Store](https://snapcraft.io/store), an app
store with an audience of millions."

# snaprd

[snaprd](https://github.com/sstark/snaprd/blob/master/README.md) is
a _backup_ utility utilizing rsync and smart hard link creation. It can be
...
*   [https://github.com/miguelgrinberg/python-socketio](https://github.com/miguelgrinberg/python-socketio) – Python Socket.IO server
*   [https://pypi.python.org/pypi/socketIO-client](https://pypi.python.org/pypi/socketIO-client) – Python Socket.IO client
*   [https://github.com/socketio/socket.io-client-swift](https://github.com/socketio/socket.io-client-swift) – ObjectiveC/Swift Socket.IO client
*   [https://github.com/socketio/socket.io-client-java](https://github.com/socketio/socket.io-client-java) – Java Socket.IO client

# ssh

*   [MOSH](https://mosh.mit.edu/)
*   [sshpass](https://www.tecmint.com/sshpass-non-interactive-ssh-login-shell-script-ssh-password/):
    can't use SSH keys for whatever reason, yet you don't want to type the
    password manually. Perhaps you're doing some kind of automation?
    Use _sshpass_!

# socat – establish two bidirectional byte streams to transfer data between them

**[Socat](http://www.dest-unreach.org/socat/doc/socat.html)** is
a command-line-based utility that establishes two bidirectional byte streams
...
a de facto standard tool for log collection, storing, processing and analysis
(incl. graphs, alerts, etc). It is a commercial offering, but it also offers
a [free version](https://www.splunk.com/en_us/software/features-comparison-chart.html),
which is usable for small-scale deployments.

*   [Splunk Deep Dive, course on Linux Academy](https://linuxacademy.com/cp/modules/view/id/336)
...
Equipment: **none**
Time: **15 - 30 minutes**
Number of Participants: **8 - 20 people** (with less, it's not so exciting)
...
random hand from a different person across the circle. Within a set time limit,
the group needs to untangle the knot of arms without releasing their hands. If
the group is too large, make multiple smaller circles and have the separate
groups compete.

_Objective: This game for team building relies heavily on good communication
and teamwork. It also results in a lot of great stories for the water cooler
chat in the workplace._

## The Perfect Square

Equipment: **blind folds and 2 (or more) ropes**
Time: **15 - 30 minutes**
Number of Participants: **5 - 20 people**

Rules: Lay the ropes in a straight line in front of each team. Have the teams
stand side by side behind the rope. Have everyone take a step or two back away
from the rope. Next, ask everyone to come back and try to form a square with
the rope without removing their blindfolds. Set a time limit to make it more
competitive. To make it even more difficult, instruct some team members to stay
silent.

_Objective: Focuses on strong communication and leadership skills. By
instructing some team members to be silent, this game also requires an element
of trust across the team, allowing team members to guide each other in the
right direction._

## Blind Draw

Equipment: **flipchart (or clipboard)**, **papers, crayons (or pencils or
pens), photos/pictures to draw (or some assortment of every day objects)
**Time: **15-30 minutes
**Number of Participants: **4-20 people**

Rules:

1\. Get a flipchart (or clipboard), markers, pencils, crayons or pens, and
a bunch of random pictures. This game works best with more unobvious objects
(say, a trampoline vs a coin).
2\. Divide all participants into teams of 4-6 people.
3\. Ask each team to pick one person to be the "artist". Ask the artists to
take their place next to the flipchart.
4\. Face the teams away from the flipcharts and present them all with one
(the same) picture.
5\. The teams will then instruct their artists on how to draw the picture based
on verbal instructions alone. They can describe the object but not state its
name. The artist can't see the object at any time, nor can the team see what
the artist is drawing.
6\. The team whose drawing comes closest to the actual object wins.

## Photo Finish

Equipment: **rope (or measuring or masking tape or long stick)**
Time: **15-30 minutes**
Number of Participants: **5-20 people**

Rules:

1\. Create a straight 'finish line' using the rope.
2\. Ask all participants to cross the finish line at exactly the same time,
i.e. a "photo finish". Participants will have to coordinate with each other
to pull this off.
3\. Take a photograph or take a video every time they cross the finish line to
see if it qualifies as a photo finish.
4\. For added difficulty, ask the participants to walk or run across the finish
line in a photo finish.

## Team Emblem/Crest

Equipment: **papers, crayons (or pencils or pens)**
Time: **15-30 minutes**
Number of Participants: **4-20 people**
...
[Teleconsole](https://www.teleconsole.com/using/) is a tool for enabling remote
access to local services, similar to ngrok. Teleconsole is different in that it
allows the other party to directly control a terminal session (with the
possibility of even being able to forward ports over the protocol), such that
both of you can actively participate in the session. (It's more or less like
a shared tmux panel over SSH or web interface).

# telegraf

[Telegraf](https://docs.influxdata.com/telegraf/v1.11/introduction/getting-started)
is an agent (written in Go) for collecting metrics and writing/sending them into
various outputs. Similar tools include CollectD for instance. It has many
plugins that facilitate its metric collection as well as storage capabilities.
For example,
the [nginx](https://www.influxdata.com/integration/nginx-monitoring-tools/)
plugin can be used to collect _requests per second, response times, active
connections, ..._ and you can ingest the metrics into
[Prometheus](https://github.com/influxdata/telegraf/tree/master/plugins/outputs/prometheus_client).

# terraform

*   [Terraform.io](https://www.terraform.io/) is in infrastructure as a code
    ...
    *   Terraform is the answer to the people who don't want the hassle of
...
*   [Understanding Test Driven Development -- Roy Osherove](https://www.youtube.com/watch?v=q5Xd1tmIgec)
*   [Understanding Mock Objects -- Roy Osherove](https://www.youtube.com/watch?v=fAb_OnooCsQ)
*   [Unit Testing Best Practices -- Roy Osherove](https://www.youtube.com/watch?v=dJUVNFxrK_4&t=3331s)
*   [Unit Testing Code Reviews Best Practices -- Roy Osherove](https://www.youtube.com/watch?v=vFh8cPCOVJw)
*   [Unit Testing and TDD: Why you should care and how to make it happen -- Roy Osherove](https://www.youtube.com/watch?v=3_UX8Kqb3aU)
*   Test Reviews
    *   [Test Review - NerdDinner -- Roy Osherove](https://www.youtube.com/watch?v=bZ1Q52ZTcD0)
    *   [Test Review - ASP.NET MVC -- Roy Osherove](https://www.youtube.com/watch?v=jVxmk-tVo7M)
    *   [Test Review - Unity -- Roy Osherove](https://www.youtube.com/watch?v=8lNDgtGwCPU)
*   [Surviving the Top Ten Challenges of Software Testing: A People-Oriented Approach](https://www.safaribooksonline.com/library/view/surviving-the-top/9780133489163/)
    *   This is quite an old one, but very good still.
*   [Beyond Unit Tests: Taking Your Testing to the Next Level, by Hillel Wayne](https://www.youtube.com/watch?v=MYucYon2-lk&feature=share)
*   [TDD Harms Architecture, by Uncle Bob](http://blog.cleancoder.com/uncle-bob/2017/03/03/TDD-Harms-Architecture.html)
*   [Test Coverage (Alone) Is A Lie!, by Stephen Mizell](https://smizell.me/writing/test-coverage-lie/)
*   [Please don't mock me, by Justin Searls](http://blog.testdouble.com/posts/2018-03-06-please-dont-mock-me)
*   [xUnit Test Patterns: Refactoring Test Code, by Gerard Meszaros](https://learning.oreilly.com/library/view/xunit-test-patterns/9780131495050/)
*   [Behavior Driven Design, course on LinkedIn Learning](https://www.linkedin.com/learning/behavior-driven-development)
*   [Thoughts on TDD (After almost 20 years), blog post by James Grenning](http://blog.wingman-sw.com/thoughts-on-tdd)

# test driven development (tdd)

*   YouTube
    *   [Understanding Test Driven Development -- Roy Osherove](https://www.youtube.com/watch?v=q5Xd1tmIgec)
    *   [TDD Pairing Session -- Roy Osherove & Raymond Lim](https://www.youtube.com/watch?v=xX9hfPkA800)
...
*   Safari Books
    ...
    *   [Testing Python: Applying Unit Testing, TDD, BDD and Acceptance Testing](https://www.safaribooksonline.com/library/view/testing-python-applying/9781118901243/)
    *   [Test-Driven Development with Python, 2nd Edition](https://www.safaribooksonline.com/library/view/test-driven-development-with/9781491958698/)
    *   [Test-Driven Python Development](https://www.safaribooksonline.com/library/view/test-driven-python-development/9781783987924/)

# textfsm

[TextFSM](https://github.com/google/textfsm/wiki/TextFSM) is both a Python
module (library) as well as command line utility that makes it very easy to
parse out information from textual data, such as your `ifconfig`/`ip` output
...
*   [Tmux](https://leanpub.com/the-tao-of-tmux/read#thinking-tmux) is
    a terminal multiplexor, like screen (for those familiar with that), which
    not only allows one to multiplex terminals in text mode, but also offers
    [integration with GUI tools, like iTerm](https://gitlab.com/gnachman/iterm2/wikis/TmuxIntegration).
*   [tmux 2 by Brian P. Hogan](https://www.safaribooksonline.com/library/view/tmux-2/9781680502374/) (Safari Books)
*   TIP: To make it easier for one to SSH into a machine equipped with tmux and
    have a constant and isolated remote tmux session either created or attached,
    one can use the below function (if placed in .bash_profile, it can then be
    used as a command)
...
[Tuleap](https://www.tuleap.org) is an open source issue tracking system and
Git source code repository. It has many features included. It can be easily
spun up using a Docker image.

# typescript

*   Safari Books
    *   [TypeScript Essentials](https://www.safaribooksonline.com/library/view/typescript-essentials/9781783985760/)
    *   [Mastering TypeScript](https://www.safaribooksonline.com/library/view/mastering-typescript/9781784399665/)
*   [TypeDI](https://github.com/typestack/typedi) is a library for both
    JavaScript and TypeScript that takes your dependency injection pains away.
*   Wondering what to put into the `target` field of your `tsconfig.json`?
    Well, if you are targetting NodeJS, you could take a look at
    [node.green](https://node.green) (the page is long and headings for more
    recent ECMAScript proopsals are close to the bottom (WHY?)). It's easy to
...
*   [Create an NPM Module with TypeScript, article by Ernesto F](https://levelup.gitconnected.com/create-a-npm-module-with-typescript-c99bd0686f69)

## gulpfile.js

This is a boiler-plate-free example `gulpfile.js` suitable for use with NodeJS.
It expects all your sources to live under `src`, and will produce their
equivalent JavaScript files in `dist`. It also expects a working Babel and
ESLint setup.

The main two targets to use from the outside are `cleanBuild` and
`buildAndWatch` (spawning a loop watching the sources and recompiling when they
change).
...
This is a boiler-plate-free example .eslintrc.js suitable for use with NodeJS.
It also includes Prettier rules, to make sure you run it against your files :).
...
## [runtypes](https://www.npmjs.com/package/runtypes)

[runtypes](https://www.npmjs.com/package/runtypes) is a TypeScript library
that makes it simple to create custom type-guarding (and validating) classes
and static typings in one go. This is the tool you will use whenever you acquire
an object at runtime that you expect to conform to a particular static type, but
you are not sure, and the static analyzer isn't either. Situations like this
usually happen when deserializing an object, parsing command line arguments, ...

## [tsdef](https://www.npmjs.com/package/tsdef)
...
"A tool for writing Linux pipes in a terminal-based UI interactively, with
instant live preview of command results.".
[Ultimate Plumber on GitHub](https://github.com/akavel/up)

# user base statistics

*   [Firefox Hardware Report](https://metrics.mozilla.com/firefox-hardware-report/) (shows SW as well)
*   [StatCounter GlobalStats -- OS, Browser, ... market shares](http://gs.statcounter.com/)

# vagrant (HashiCorp Vagrant)

[Vagrant](https://www.vagrantup.com/intro/index.html) is a tool (and
an ecosystem) that enables one to deploy and provision virtual machines onto
many different hypervisors (e.g. VirtualBox, Hyper-V, AWS, ...).

*   [Learning Vagrant, course on LinkedIn Learning](https://www.linkedin.com/learning/learning-vagrant/welcome?u=2141129)

# [ventoy](https://www.ventoy.net/en/index.html)

Yet another bootable USB flash drive creator. This ones is different, though,
as it allows for multiple different ISOs to be placed onto the drive and used
to boot up. Should you need a different ISO, just place it there, or replace
the previous, or keep all of them. No need to reformat, like some of the other
tools need.

# vault (HashiCorp Vault)

[HashiCorp's Vault](https://learn.hashicorp.com/vault#operations-and-development)
is an open-source platform for secrets management and data protection
(encryption). It supports many different authentication schemes. It can talk to
different storage backends (file, in-memory, Consul, ...) and it also supports
various features, such as automatic user creation in AWS, databases, ...

*   [Day 1: Deploying Your First Vault Cluster, tutorial by HashiCorp](https://learn.hashicorp.com/vault?track=day-one#day-one)
...
*   [Introductory Videos, by the VSCode authors](https://code.visualstudio.com/docs/getstarted/introvideos)
...
# [xon.sh](https://xon.sh/tutorial.html)
...
The xonsh command prompt gives users interactive access to the xonsh language."

# yaml

aka "yaml ain't markup language", is a serialization format (similarly to JSON)
that targets to be very easy to write and read by humans. Used widely for
configuration files, but even has support for document streaming.
